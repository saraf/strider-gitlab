...
module.exports = function() {
  ...
  nock('http://localhost:80')
    ...
    .query({"private_token":"zRtVsmeznn7ySatTrnrp"})
    .reply(400, {"message":{"key":["is invalid"],"fingerprint":["cannot be generated"]}}, { server: 'nginx',
  ...
  nock('http://localhost:80')
  .post('/api/v3/projects/wrong%20repo%20id/keys', {"title":"strider-stridertester/privproject1","key":"ssh-rsa  stridertester/privproject1-stridertester@gmail.com\n"})
  .query({"private_token":"zRtVsmeznn7ySatTrnrp"})
