...
module.exports = function() {
  ...
  nock('http://localhost:80')
    .post('/api/v3/projects/5/hooks', {"url":"http://localhost:3000/stridertester/privproject1/api/gitlab/webhook","push_events":true})
    .query({"private_token":"zRtVsmeznn7ySatTrnrp"})
    .reply(201, {"id":18,"url":"http://localhost:3000/stridertester/privproject1/api/gitlab/webhook","created_at":"2015-08-21T14:11:54.922Z","project_id":5,"push_events":true,"issues_events":false,"merge_requests_events":false,"tag_push_events":false}, { server: 'nginx',
  ...
  nock('http://localhost:80')
    .post('/api/v3/projects/5/keys', {"title":"strider-stridertester/privproject1","key":"ssh-rsa  stridertester/privproject1-stridertester@gmail.com\n"})
    .query({"private_token":"zRtVsmeznn7ySatTrnrp"})
    .reply(201, {"id":22,"title":"strider-stridertester/privproject1","key":"ssh-rsa  stridertester/privproject1-stridertester@gmail.com","created_at":"2015-08-21T14:11:54.986Z"}, { server: 'nginx',
  ...
  nock('http://localhost:80')
  .post('/api/v3/projects/invalid-repo/hooks', {"url":"http://localhost:3000/stridertester/privproject1/api/gitlab/webhook","push_events":true})
  .query({"private_token":"zRtVsmeznn7ySatTrnrp"})
  .reply(404, ["1f8b0800000000000003ab56ca4d2d2e4e4c4f55b252323130510828cacf4a4d2e51f0cb2f5170cb2fcd4b51aa050037095a2823000000"], { server: 'nginx',
  ...
  .query({"private_token":"zRtVsmeznn7ySatTrnrp"})
  .reply(400, {"message":"400 (Bad request) \"url\" not given"}, { server: 'nginx',
