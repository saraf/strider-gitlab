...
module.exports = {
  ...
  getBranches: function (account, config, project, done) {
    debug("getFile called with account: " + util.inspect(account,false,10,true));
    debug("getFile called with config: " + util.inspect(config,false,10,true));
    debug("getFile called with project: " + util.inspect(project,false,10,true));
